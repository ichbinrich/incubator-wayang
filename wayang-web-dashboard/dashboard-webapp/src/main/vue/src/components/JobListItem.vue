<!--
  ...
  <template>
    <tr>
      ...
      <td><span :class="bgClass">{{ job.stages[0] }}</span><span class="badge bg-dark rounded-0">{{ job.stages[1] }}</span>
      </td>
      <td><span :class="bgClass">{{ job.tasks[0] }}</span><span class="badge bg-dark rounded-0">{{ job.tasks[1] }}</span>
      </td>
      <td>
        <span :class="bgClass">{{ job.status }}</span>
      </td>
      <td>
        <span v-for="plugin in job.plugins" :key="plugin" class="badge bg-info rounded-0 border border-2">{{ plugin
        }}</span>
      </td>
      <td>
