...
<template>
  <tr class="tuple">
    ...
    <td>
      <div class="d-flex">
        <div class="ml-auto">
          <i v-if="tuple.hackit_tuple.metadata.tags.includes('MONITOR')" class="fas fa-magnifying-glass" style="margin-left: -30px;" title="Monitor"></i>
          <i v-if="tuple.hackit_tuple.metadata.tags.includes('DEBUG')" class="fas fa-bug red-icon text-danger" style="margin-left: 5px;" title="Debug"></i>
        </div>
      </div>
    </td>
    <td>
